...
class TouchAction(object):
    ...
    def press(self, el=None, x=None, y=None, pressure=None):
        ...
        Args:
            el (:obj:`appium_study.webdriver.webelement.WebElement`, optional): the element to press
    ...
    def move_to(self, el=None, x=None, y=None):
        ...
        Args:
            el (:obj:`appium_study.webdriver.webelement.WebElement`, optional): the element to be moved to
