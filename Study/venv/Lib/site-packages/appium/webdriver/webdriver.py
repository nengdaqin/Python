...
# override
# Add appium_study prefix for the non-W3C capabilities


def _make_w3c_caps(caps):
    appium_prefix = 'appium_study:'
...
class WebDriver(
    ...
    def find_element(self, by=By.ID, value=None):
        ...
        Returns:
            `appium_study.webdriver.webelement.WebElement`
    ...
    def find_elements(self, by=By.ID, value=None):
        ...
        Returns:
            :obj:`list` of :obj:`appium_study.webdriver.webelement.WebElement`
    ...
    def _addCommands(self):
        ...
        # appium_study.webdriver.webdriver.WebDriver and its sub-classes
        ...
        self.command_executor._commands[Command.SET_IMMEDIATE_VALUE] = \
            ('POST', '/session/$sessionId/appium_study/element/$id/value')

        # TODO Move commands for element to webelement
        self.command_executor._commands[Command.REPLACE_KEYS] = \
            ('POST', '/session/$sessionId/appium_study/element/$id/replace_value')
