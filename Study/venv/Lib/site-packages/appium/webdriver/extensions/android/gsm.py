...
class Gsm(webdriver.Remote):
    ...
    def make_gsm_call(self, phone_number, action):
        ...
        Args:
            ...
            action (str): The call action.
                A member of the const `appium_study.webdriver.extensions.android.gsm.GsmCallActions`
    ...
    def set_gsm_signal(self, strength):
        ...
        Args:
            strength (int): Signal strength.
                A member of the enum `appium_study.webdriver.extensions.android.gsm.GsmSignalStrength`
    ...
    def set_gsm_voice(self, state):
        ...
        Args:
            state (str): State of GSM voice.
                A member of the const `appium_study.webdriver.extensions.android.gsm.GsmVoiceState`
    ...
    def _addCommands(self):
        self.command_executor._commands[Command.MAKE_GSM_CALL] = \
            ('POST', '/session/$sessionId/appium_study/device/gsm_call')
        self.command_executor._commands[Command.SET_GSM_SIGNAL] = \
            ('POST', '/session/$sessionId/appium_study/device/gsm_signal')
        self.command_executor._commands[Command.SET_GSM_VOICE] = \
            ('POST', '/session/$sessionId/appium_study/device/gsm_voice')
