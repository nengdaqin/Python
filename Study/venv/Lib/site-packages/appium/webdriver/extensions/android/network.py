...
class Network(webdriver.Remote):
    ...
    def network_connection(self):
        ...
        Android only.
        Possible values are available through the enumeration `appium_study.webdriver.ConnectionType`
        """
    ...
    def set_network_connection(self, connection_type):
        ...
        These are available through the enumeration `appium_study.webdriver.ConnectionType`

        Args:
            connection_type (int): a member of the enum appium_study.webdriver.ConnectionType
    ...
    def set_network_speed(self, speed_type):
        ...
        Args:
            speed_type (str): The network speed type.
                A member of the const appium_study.webdriver.extensions.android.network.NetSpeed.
    ...
    def _addCommands(self):
        self.command_executor._commands[Command.TOGGLE_WIFI] = \
            ('POST', '/session/$sessionId/appium_study/device/toggle_wifi')
        ...
        self.command_executor._commands[Command.SET_NETWORK_SPEED] = \
            ('POST', '/session/$sessionId/appium_study/device/network_speed')
