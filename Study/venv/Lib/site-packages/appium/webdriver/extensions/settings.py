...
class Settings(webdriver.Remote):
    def get_settings(self):
        """Returns the appium_study server Settings for the current session.
    ...
    def _addCommands(self):
        self.command_executor._commands[Command.GET_SETTINGS] = \
            ('GET', '/session/$sessionId/appium_study/settings')
        self.command_executor._commands[Command.UPDATE_SETTINGS] = \
            ('POST', '/session/$sessionId/appium_study/settings')
